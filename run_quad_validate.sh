...
for i in {0..10}; do
	...
	python make_config.py -p ggF --default-value $a --limit-pars 7 --default-value-inactive 0
	cp param_card.dat cards/${PROCESS}/
	...
	rivet -v --analysis=SimpleHiggs "${TMPDIR}/fifo.hepmc" -o "${SAVEDIR}_$i.yoda"
